...
export class AdminDashboardPage {
  ...
  async loadStats() {
    const [listingsRes, usersRes, recentRes] = await Promise.all([
      ...
      <div>
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: calc(var(--spacing) * 4);">
          ...
          <nav style="display: flex; gap: calc(var(--spacing) * 2);">
            ...
            <a href="/admin/listings" class="btn-secondary">Manage Listings</a>
        ...
        <div style="margin-top: calc(var(--spacing) * 6);">
          <h2 style="font-size: 24px; font-weight: 600; margin-bottom: calc(var(--spacing) * 3);">Recent Listings</h2>
